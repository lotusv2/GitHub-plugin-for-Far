...
- **F5** — копирование файлов из GitHub на локальную панель и загрузка локальных файлов в GitHub;
- **F8** — удаление файлов и каталогов из выбранной ветки с подтверждением;
- поддержка рекурсивного копирования и удаления каталогов;
- создание каталогов через `.gitkeep`;
- корректная обработка SHA существующих файлов при загрузке;
...
- **F5** — копирование файлов между локальной файловой системой и GitHub;
- **F8** — удаление выбранных файлов или каталогов.
